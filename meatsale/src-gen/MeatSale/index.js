...
class HFContract extends Contract {
  ...
  async init(ctx, args) {
    ...
    const contractInstance = new MeatSale (inputs.buyer,inputs.seller,inputs.qnt,inputs.qlt,inputs.amt,inputs.curr,inputs.payDueDate,inputs.delAdd,inputs.effDate,inputs.delDueDateDays,inputs.del,inputs.interestRate)
